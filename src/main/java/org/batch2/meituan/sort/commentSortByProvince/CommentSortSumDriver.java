...
public class CommentSortSumDriver {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, CommentSortSumDriver.class.getSimpleName());

        //设置mr程序运行的主类
        job.setJarByClass(CommentSortSumDriver.class);

        //设置本次mr程序的mapper类型、reducer类型
        job.setMapperClass(CommentSortSumMapper.class);
