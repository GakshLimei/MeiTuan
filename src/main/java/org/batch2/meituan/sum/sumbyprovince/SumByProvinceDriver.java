 ...
 */
public class SumByProvinceDriver {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, SumByProvinceDriver.class.getSimpleName());

        //设置mr程序运行的主类
        job.setJarByClass(SumByProvinceDriver.class);

        //设置本次mr程序的mapper类型、reducer类型
        job.setMapperClass(SumByProvinceMapper.class);
        job.setReducerClass(SumByProvinceReducer.class);
        ...
        Path outputPath = new Path("output/meituan/sumbyprovince");
