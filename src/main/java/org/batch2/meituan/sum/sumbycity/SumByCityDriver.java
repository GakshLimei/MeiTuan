package org.batch2.meituan.sum.sumbycity;
...
public class SumByCityDriver {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, SumByCityDriver.class.getSimpleName());

        //设置mr程序运行的主类
        job.setJarByClass(SumByCityDriver.class);

        //设置本次mr程序的mapper类型、reducer类型
        job.setMapperClass(SumByCityMapper.class);
        job.setReducerClass(SumByCityReducer.class);
        ...
        Path outputPath = new Path("output/meituan/sumbycity");
