 ...
 * @desc: 需求：将每个州累计确诊病例，每个州state的确诊案例数进行倒序排序。
 * 分析：
 ...
 */
public class CommentSortSumMapper extends Mapper<LongWritable, Text, CommentSortByProvinceBean, Text> {

    /**
     * 3、创建输出对象
     */
    CommentSortByProvinceBean outKey = new CommentSortByProvinceBean();
